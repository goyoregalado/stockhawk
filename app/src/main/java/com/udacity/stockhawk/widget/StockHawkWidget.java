...
public class StockHawkWidget extends AppWidgetProvider {
    ...
    private void setRemoteAdapter(Context context, RemoteViews views) {
        Intent stockHawkRemoteAdapter = new Intent(context, StockHawkWidgetRemoteViewsService.class);
        views.setRemoteAdapter(R.id.widget_list, stockHawkRemoteAdapter);
    }
